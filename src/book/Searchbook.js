...
class SearchBook extends Component{
    ...
    handleSubmit(e){
        ...
        const url = `https://www.googleapis.com/books/v1/volumes?q=${title}&printType=${printType}&categories=${categories}&maxResults=10&key=AIzaSyB0QiaITWht9IMj8ax5jKmtACQsM81RApA`;
